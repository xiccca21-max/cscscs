                      ...
                      >
                        ...
                        <td>
                          <span className="ord-row__actions">
                            ...
                            <button className="ord-row__action-btn ord-row__action-btn--support" title="Support" onClick={(e) => { e.stopPropagation(); window.open("mailto:support@skinsell.com", "_blank"); }}>
